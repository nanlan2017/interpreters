(module data-structures (lib "eopl.ss" "eopl")
  ...
  (define-datatype ThreadContext ThreadContext?
    ($a-thread-context
     (id integer?)
     (ref-to-msgs reference?) ; msgs 是一个quene
     (msg-mut Mutex?)))

  (define (thread-context->id ctx)
    (cases ThreadContext ctx
      ($a-thread-context (id ref msg)
                         id)))
